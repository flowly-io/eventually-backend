 ...
 *
 * @param {string[]} paths a list of paths to load .graphql files from
 * @returns the schema as a single string
 */
const constructSchemaFromFiles = paths => {
 ...
 *
 * @param {string} schema the schema as a string
 * @returns the modified schema as a single string
 */
const mergeRootFields = schema => {
